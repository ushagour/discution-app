    ...
    <div class="col-xs-12">
        ...
        <section class="panel">
            <header class="panel-heading">
                ...
                <h2 class="panel-title">Add new discussion</h2>
            </header>
            <div class="panel-body">

                <form class="form-horizontal form-bordered" action="{{Route('discussions.store')}}" method="post">
                    @csrf
                    ...
                    <!-- <div class="form-group">
						...
						Enjoy!</textarea>
											...
											<div class="form-group">
                    <button type="submit" class="mb-xs mt-xs my-2 btn btn-SUCCESS btn-lg btn-block">ADD</button>
                    </div>
                </form>
            </div>
        </section>
